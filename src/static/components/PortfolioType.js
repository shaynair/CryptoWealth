...
class PortfolioType extends React.Component {
  ...
  render() {
    let portfolioTypes = { conservative:"Based on what you told us about yourself, we recommend a portfolio asset mix focused on income. Your returns will rarely fluctuate, provide income, and give returns just above inflation. You can always change your plan at any time.", balanced:"ased on what you told us about yourself, we recommend a portfolio asset mix roughly split between growth and income. You can expect to see some downturns, for returns above inflation. You can always change your plan at any time.", aggressive:"Your portfolio asset mix is focused on growth. Based on what you told us about yourself, we recommend a long-term time frame with ability to accept some ups and downs to achieve the highest return. You can always change your plan at any time.", error:"An error occurred... (╯°□°）╯︵ ┻━┻"};
